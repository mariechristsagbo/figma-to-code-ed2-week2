      ...
      <div className="flex flex-col lg:flex-row gap-8 justify-between">
        <div className="lg:w-[60%]">
          ...
          <div className="bg-white p-6 rounded-lg">
            ...
            <p className="text-b-dark-gray mb-6">
              By placing your order, you agree to Ballamas{' '}
              <a href="#" className="underline text-b-black">
                Privacy
              </a>{' '}
              and{' '}
              <a href="#" className="underline text-b-black">
            ...
            {cart.map(product => (
              <div key={product.id} className="flex items-center justify-between mb-4">
                ...
                <p className="text-lg font-semibold">${product.price * product.quantity}.00</p>
              </div>
            ))}
            <div className="mt-6 mb-4">
              ...
              <div className="flex items-center justify-between mt-2">
                <input
                  ...
                  className="border border-b-dark-gray p-3 px-5 rounded-full flex-grow mr-2 text-b-black"
                />
                <button className="bg-black text-white p-3 px-5 rounded-full font-semibold">Apply</button>
              </div>
            </div>

            <p className="text-sm text-b-black">
              New customer?{' '}
              ...
              <div className="py-10">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {paymentMethods.map((method, index) => (
                    <label
                      key={index}
                      className="flex flex-col space-y-2 border hover:border-b-dark-gray rounded-xl py-5 px-4 cursor-pointer"
                    >
                      <Image alt={method.label} src={method.image} width={30} height={30} />
